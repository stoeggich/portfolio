...
public class TradegateAGPDFExtractorTest
{
    ...
    public void testWertpapierKauf03()
    {
        ...
        // check security
        assertThat(results, hasItem(security( //
                        hasIsin("IE0005AJA0P1"), hasWkn("A41L70"), hasTicker(null), //
                        hasName("Legal&General ETF-Gl.Qual.Div. Reg.Shs USD Dis. oN"), //
                        hasCurrencyCode("EUR"))));
    ...
    public void testVorabpauschale03()
    {
        ...
        // check security
        assertThat(results, hasItem(security( //
                        hasIsin("IE00BMWXKN31"), hasWkn("A2QHV0"), hasTicker(null), //
                        hasName("HSBC ETFS-H.Hang Seng Tech Reg. Shs HKD Acc. oN"), //
                        hasCurrencyCode("EUR"))));

        // check taxes transaction
        assertThat(results, hasItem(taxes( //
                        hasDate("2026-01-02"), hasShares(1550.00), //
                        hasSource("Vorabpauschale03.txt"), //
                        hasNote("Order-/Ref.nr. 20061070"), //
    ...
    public void testKontoauszug01()
    {
        ...
        // assert transaction
        assertThat(results, hasItem(deposit(hasDate("2024-12-09"), hasAmount("EUR", 75.00), //
                        hasSource("Kontoauszug01.txt"), hasNote("Ref.nr. 9668834"))));
    }
    ...
    public void testKontoauszug02()
    {
        ...
        // assert transaction
        assertThat(results, hasItem(removal(hasDate("2026-03-02"), hasAmount("EUR", 10.72), //
                        hasSource("Kontoauszug02.txt"), hasNote("Ref.nr. 38063139"))));
    }
}
